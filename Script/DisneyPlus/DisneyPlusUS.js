...
let home_location = { "country_code": "US" };
...
if (typeof $argument != "undefined") {
	...
	location.asn = arg.asn ? arg.asn : 46997;
	location.country_code = arg.country_code ? arg.country_code : "US";
	location.carrier = arg.carrier ? arg.carrier : "black mesa corporation";
	location.city_name = arg.city_name ? arg.city_name : "syracuse";
	location.connection_type = arg.connection_type ? arg.connection_type : "";
	location.dma = arg.dma ? arg.dma : 555;
	home_location.country_code = arg.country_code ? arg.country_code : "US";
};
