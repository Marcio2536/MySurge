...
async function testDisneyPlus() {
  try {
    ...
    let { countryCode, inSupportedLocation } = await Promise.race([getLocationInfo(), timeout(options.timeout)])
